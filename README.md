# Note
This package is being superseded by [QuAcc](https://github.com/arosen93/quacc), which has a QMOF "recipe" (i.e. `from quacc.recipes.vasp.qmof import QMOFRelaxJob`). The current project should be considered deprecated and will not be maintained.
