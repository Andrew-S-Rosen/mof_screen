...
def prep_paths(basepath):
	...
	clean_files(['run_vasp.py','neb.tar.gz','AECCAR0','AECCAR0.gz','AECCAR1','AECCAR2','AECCAR2.gz','CENTCAR','CHG','ase-sort.dat','DIMCAR','DOSCAR','EIGENVAL','IBZKPT','OSZICAR','PCDAT','PROCAR','REPORT','XDATCAR','WAVECAR','WAVECAR.gz','CHGCAR','CHGCAR.gz','STOPCAR'])
	vtst_cleanup()
...
def manage_restart_files(file_path,dimer=False,neb=False,wavechg=True):
	...
	gzip_list = ['AECCAR0','AECCAR2','CHGCAR','DOSCAR','WAVECAR','vasprun.xml']
