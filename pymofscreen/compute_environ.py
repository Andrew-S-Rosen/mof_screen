...
def choose_vasp_version(gpt_version,nprocs):
	...
	with open('run_vasp.py','w') as runvasp_file:
		#Setup for A.S. Rosen on Quest
		parallel_cmd = 'mpirun -n'+' '+str(nprocs)+' '
		vasp_path = '/projects/b1013/vasp_builds/10-10-19-541/vasp.5.4.1/bin/'
		vasp_ex = [f'{vasp_path}vasp_std', f'{vasp_path}vasp_gam']
		...
		# vasp_path = ''
		# vasp_ex = [vasp_path+'vasp-vtst',vasp_path+'vasp_real-vtst']
